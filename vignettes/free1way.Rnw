...
\NWtarget{nuweb?}{} $\langle\,${\itshape logLik, gradient, Hessian}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Jeffreys penalisation}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape power inversion}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item \verb@"utils.R"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb?}{?}.}
\end{list}}
